...
tf.app.flags.DEFINE_string('image_dir', 'images/train_photos',
...
# TODO: We have to apply data augmentation, just not every time, this should be done once and this code should be removed from this script.
...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor):
    ...
    with tf.name_scope('train'):
        ...
        # TODO: change to Adam optimization.
...
def main(_):
    ...
    (train_step, cross_entropy, bottleneck_input, ground_truth_input,final_tensor) = add_final_training_ops(class_count,
